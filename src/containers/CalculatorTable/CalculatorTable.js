                            ...
                            <TableBody>
                                ...
                                {Data.map(item => {
                                    return <TableRow className={classes.oddEvenRow}>
                                        ...
                                        <TableCell className={classes.tabledata}>₹ {item.principal}</TableCell>
                                        <TableCell className={classes.tabledata}>₹ {item.interestPaid}</TableCell>
                                        <TableCell className={classes.tabledata}>
                                            <div className="progressTableContainer">
                                                ...
                                                <div className="bottomSection">
                                                    <div className="textProgress" style={{ color: '#5DC699' }}>74.9%</div>
                                                    <div className="textProgress" style={{ color: '#F18A8A' }}>25.1%</div>
                                                </div>
                                            </div>
                                        </TableCell>
                                        <TableCell className={classes.tabledata}>₹ {item.monthEndBalance}</TableCell>
                                    </TableRow>
                                })}
                            </TableBody>
                        </Table>
                ...
                <Grid lg={3}>
                    ...
                    <div className="shareConatiner">
                        ...
                        <div className='socialMediaContainer'>
                            ...
                            <DraftsRoundedIcon className='emailIcon' />
                            <GetAppRoundedIcon className='downloadIcon' />
                        </div>
                    </div>
                </Grid>
            </Grid>
