...
export const getCampaign = () => {
    ...
    // 'ROHIT_PQ_CAMPAIGN','ROHIT_PQ_HOT_CAMPAIGN','IDFC_CC','YES_BANK_CC'];

    const campaign = ['FRESH_PL_OD', 'BT_PL_OD', 'PL_OD_TOP_UP', 'HOT_LEAD_SILVER_NOIDA', 'HOT_LEAD_SILVER_MUMBAI',
        'HOT_LEAD_PLATINUM_NOIDA', 'HOT_LEAD_PLATINUM_MUMBAI', 'ELITE_CUSTOMER_MUMBAI', 'ELITE_CUSTOMER_NOIDA',
        'WEBSITE_LEAD', 'OTHER', 'SURAJ_TEAM_PL', 'SURAJ_BT_CAMPAIGN', 'IMTIYAZ_BT_CAMPAIGN', 'ROHIT_PQ_CAMPAIGN',
        'ROHIT_PQ_HOT_CAMPAIGN', 'MUMBAI_CAMPAIGN_1', 'MUMBAI_CAMPAIGN_2', 'MUMBAI_CAMPAIGN_3', 'MUMBAI_CAMPAIGN_4',
        'ROHIT_PQ_CAMPAIGN', 'ROHIT_PQ_HOT_CAMPAIGN', 'IVR_PL_1', 'IVR_PL_2', 'IVR_PL_3', 'IVR_PL_4', 'IDFC_CC',
        'YES_BANK_CC']
    return campaign;
}
