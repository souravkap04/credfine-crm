...
export const getCampaign = () => {
    const campaign = ['FRESH_PL_OD', 'BT_PL_OD', 'PL_OD_TOP_UP', 'HOT_LEAD_SILVER_NOIDA', 'HOT_LEAD_SILVER_MUMBAI',
        ...
        'WEBSITE', 'OTHER', 'OWN_LEAD', 'SURAJ_TEAM_PL', 'SURAJ_BT_CAMPAIGN', 'IMTIYAZ_BT_CAMPAIGN', 'ROHIT_PQ_CAMPAIGN',
        'ROHIT_PQ_HOT_CAMPAIGN', 'MUMBAI_CAMPAIGN_1', 'MUMBAI_CAMPAIGN_2', 'MUMBAI_CAMPAIGN_3', 'MUMBAI_CAMPAIGN_4',
        'IVR_PL_1', 'IVR_PL_2', 'IVR_PL_3', 'IVR_PL_4', 'GANESH_HL', 'GANESH_BL', 'GANESH_LAP', 'IDFC_CC', 'YES_BANK_CC']
    return campaign;
}
